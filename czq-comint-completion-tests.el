              ...
              (unwind-protect
                  (progn
                    ...
                    (let ((sent-command nil)
                          (request-messages '())
                          (original-output czq-comint-output-enabled))
                      ...
                      (should-not (string-match-p "(setq czq-comint-output-enabled t)"
                                                  sent-command))
                      (should-not (string-match-p "<czq-comint handler=elisp>(setq czq-comint-output-enabled t)</czq-comint>"
                                                  sent-command))
                      (should-not (string-match-p "restore" sent-command))
